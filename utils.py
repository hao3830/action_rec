...
def choose_run_mode(args):
    ...
    if args.video:
        ...
        out_file_path = str(out_file_path / 'webcam_tf_out.avi')
    return cap
...
def set_video_writer(cap,args, write_fps=15):
    return cv.VideoWriter(str(file_path) + '/out_video/'  + f'{args.name}.avi',
