...
# print(encoder_Y)
# train test split
encoder_Y = [1]*int(dataset.shape[0]/2) + [0]*(dataset.shape[0] - int(dataset.shape[0]/2))
...
model.fit(X_train, Y_train, batch_size=32, epochs=100000, verbose=1, validation_data=(X_test, Y_test), callbacks=[his])
model.summary()
his.loss_plot('epoch')
print(2)
model.save('AIC_framewise_recognition.h5')
